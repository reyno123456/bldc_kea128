...
extern void Can_ISR_Wake_0(void);
extern void Can_ISR_Rx_0(void);
...
void (* const InterruptVector[])() __attribute__ ((section(".vectortable"))) = {
    ...
    FMSTR_Isr,              /* UART2 Status and Error interrupt */
	ADC_ISR,		        /* ADC conversion complete interrupt */
    ACMP0_IRQHandler,		/* Analog comparator 0 interrupt */
    FTM0_ISR,		        /* Single interrupt vector for all sources */
    ...
    Can_ISR_Rx_0,	        /* MSCAN Rx Interrupt */
